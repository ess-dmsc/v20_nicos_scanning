...
POSITIONS_1 = np.arange(25, 35, 0.3)
width = 5
height = 0.2
center_x = -11.7
...
def do_scan(center_x, width, height):
    ...
    for i in POSITIONS_1:
        ...
        #maw(NICOS_MOTOR_1, i)
        maw(NICOS_MOTOR_1, (center_x, i, width, height))
    ...
    file = open("/hzb/caress/mike/v20_nicos_scanning/scans/%s_scan.dat" % (NICOS_MOTOR_1,), "w")
